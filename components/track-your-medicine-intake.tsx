    ...
    <div className="flex flex-col">
      ...
      <main>
        <div className="pt-81 flex flex-col gap-4 justify-center !items-center">
          ...
          <div className="flex gap-45 flex-col">
            <article
              className="!rounded-lg h-[562px] pt-5 px-[13px] flex gap-1 !bg-cover !bg-[center] !bg-no-repeat w-[1027px]"
            ...
            <div className="flex justify-between">
              ...
              <section className="max-w-[700px] text-[#121416] flex flex-col gap-20 font-jakarta text-base/200 font-normal">
                ...
                <section className="flex flex-col gap-10">
                  <article className="flex gap-6 items-start">
                    ...
                    <blockquote className="font-sora text-4xl uppercase font-semibold">
