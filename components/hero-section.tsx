...
export function HeroSection() {
  return (
    <div className="grid gap-96 pt-90 pb-70 [@media(min-width:874px)]:grid-cols-2 md:px-96 px-5">
      <section className="flex flex-col gap-3">
        <article className="rounded-[60px] py-3 px-[14px] gap-[10px] border border-[#D1E5FF] bg-primary-50 sm:flex w-fit [@media(max-width:643px)]:hidden">
        ...
        <h2 className="font-sora text-4xl/150 font-bold text-primary-900  [@media(min-width:874px)]:max-w-[533px]">
          Revolutionary Medication Adherence Solutions for Chronic Wellness
        </h2>

        <p className="font-jakarta text-[16px]/150 font-normal [@media(min-width:874px)]:max-w-[533px]">
